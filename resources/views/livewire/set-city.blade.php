<div>
    <div class="fixed top-0 left-0 w-full h-full flex justify-center items-center z-50">
        <div class="fixed inset-0 h-screen bg-cover bg-center" style="background-color:rgba(0, 0, 0, 0.603) ">
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="p-4 md:p-5">
                                    <form class="space-y-4" action="#">
                                        <p>Informe CEP para localizarmos a melhor unidade para você</p>
                                        <div>
                                            <label for="email"
